...
<body>
    ...
    <table width="100%" style="font-family: sans-serif;" cellpadding="10">
        <tr>
            <td width="49%" style="border: 0.1mm solid #fff;"><strong>Invoice No:</strong> #{{ $sales[0]->invoice_no }}<br><strong>Invoice Date:</strong> #{{ date('F j, Y') }}<br><strong>Customer Name: </strong> {{ $customers->customer_name }}<br><br><strong>Telephone:</strong> {{ $customers->customer_phone }}</td>
            <td width="2%">&nbsp;</td>
    ...
    <table class="items" width="100%" style="font-size: 14px; border-collapse: collapse;" cellpadding="8">
        ...
        <tbody>
            ...
            <tr>
                <td>1</td>
                <td>{{ 'Payment to Supplier for Invoice ' . $sales[0]->invoice_no }}</td>
                <td>{{ $sales[0]->total }}</td>
                <td>{{ $sales[0]->discount }}</td>
                <td>{{ $sales[0]->paid }}</td>
            ...
            <td>
                ...
                <table width="30%" align="right" style="font-family: sans-serif; font-size: 14px;" >
                    <tr>
                        ...
                        <td style="border: 1px #eee solid; padding: 0px 8px; line-height: 20px; text-align:right;">{{ $sales[0]->total }}</td>
                    </tr>
                    <tr>
                        <td style="border: 1px #eee solid; padding: 0px 8px; line-height: 20px; text-align:right;"><strong>Total Paid</strong></td>
                        <td style="border: 1px #eee solid; padding: 0px 8px; line-height: 20px; text-align:right;">{{ $sales[0]->paid }}</td>
                    </tr>
                    <tr>
                        <td style="border: 1px #eee solid; padding: 0px 8px; line-height: 20px; text-align:right;"><strong>Discount</strong></td>
                        <td style="border: 1px #eee solid; padding: 0px 8px; line-height: 20px; text-align:right;">{{ $sales[0]->discount }}</td>
                    </tr>
                    <tr>
                        <td style="border: 1px #eee solid; padding: 0px 8px; line-height: 20px; text-align:right;"><strong>Total Due</strong></td>
                        <td style="border: 1px #eee solid; padding: 0px 8px; line-height: 20px; text-align:right;">{{ $sales[0]->due  }}</td>
                    </tr>
                </table>
            </td>
        </tr>
