...
@section('content')
        ...
        <div class="content">
            <div class="container-fluid">
                ...
                <div class="card card-success " id="cards">
                    ...
                    <!-- /.card-header -->
                    <div class="card-body">
                        <form action="{{ route('admin.getCusPayment') }}" method="post" id="getCusPayment"
                ...
                <div class="modal-body">
                    <form action="{{ route('admin.updateCustomerPayment') }}" method="post" id="update-cus-payment-form">
                        ...
                        <div class="form-group">
                            ...
                            <select name="accounts" class="form-control" id="" required>
    ...
    <div class="modal fade editBrand1 modal3" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true" data-keyboard="false" data-backdrop="static">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <script>
        ...
        $(function() {
            ...
            $(document).on('click', '#editBrandBtn', function() {
                ...
                $.post("{{ route('admin.getCustomerPaymentDetails') }}", {
            ...
            $('#update-cus-payment-form').on('submit', function(e) {
                ...
                $.ajax({
                    url: $(form).attr('action'),
                    method: $(form).attr('method'),
                    data: formData, // send updated FormData
                    processData: false,
                    dataType: 'json',
                    contentType: false,
                    beforeSend: function() {
            ...
            $('#update-cus-payment-form1').on('submit', function(e) {
                ...
                $.ajax({
                    url: $(form).attr('action'),
                    method: $(form).attr('method'),
                    data: formData, // use the updated FormData here
                    processData: false,
                    dataType: 'json',
                    contentType: false,
                    beforeSend: function() {
