    ...
    <div class="content">
      <div class="container-fluid">
        ...
        <div class="card card-success " id="cards">
          ...
          <!-- /.card-header -->
          <div class="card-body">
            <form action="{{ route('admin.getSupPayment') }}" method="post" id="getSupPayment" class="agetSupPayment" autocomplete="off">
              @csrf
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <select name="category" class="form-control category" id="myselection" required>
                            ...
                            <option value="Two">Supplier Wise</option>
                        </select>
                    ...
                    <div id="showTwo" class="myDiv">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <select class="form-control form-control-sm select2bs4"   name="supplier_id" id="supplier_id">
                                <option value="all">All Suppliers</option>
                                @foreach ($suppliers as $sup)
                                    <option value="{{ $sup->id }}">{{ $sup->supplier_name .' - '. $sup->supplier_phone }}</option>
                                @endforeach
                              </select>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Payment to Supplier</h5>
                    ...
                    <div class="modal-body">
                         <form action="{{ route('admin.updateSupplierPayment'); }}" method="post" id="update-sup-payment-form">
                            @csrf
...
<script>
    toastr.options.preventDuplicates = true;
      ...
      $(function(){
        ...
        $('#getSupPayment').on('submit', function(e){
                e.preventDefault();
                var form = this;
                $.ajax({
            ...
            $(document).on('click','#editBrandBtn', function(){
                ...
                $.post("{{ route('admin.getSpplierPaymentDetails') }}",{invoice_no:invoice_no}, function(data){
            ...
            $('#update-sup-payment-form').on('submit', function(e){
                e.preventDefault();
                var form = this;
                $.ajax({
                    url:$(form).attr('action'),
