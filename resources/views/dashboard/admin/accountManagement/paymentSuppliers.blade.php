        ...
        <div class="content">
            <div class="container-fluid">
                ...
                <div class="card card-success " id="cards">
                    ...
                    <!-- /.card-header -->
                    <div class="card-body">
                        <form action="{{ route('admin.getSupPayment') }}" method="post" id="getSupPayment"
                            class="agetSupPayment" autocomplete="off">
                            @csrf
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div id="showTwo" class="myDiv">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <select class="form-control form-control-sm select2bs4" name="supplier_id"
                                                    id="supplier_id">
                                                    <option value="all">All Suppliers</option>
                                                    @foreach ($suppliers as $sup)
                                                        <option value="{{ $sup->id }}">
                                                            {{ $sup->supplier_name . ' - ' . $sup->supplier_phone }}</option>
                                                    @endforeach
                                                </select>
    ...
    <script>
        ...
        $(function() {
            ...
            $(document).on('click', '#editBrandBtn', function() {
                ...
                $.post("{{ route('admin.getSpplierPaymentDetails') }}", {
