    ...
    <div class="content">
      <div class="container-fluid">
        ...
        <div class="card card-success " id="cards">
          ...
          <!-- /.card-header -->
          <div class="card-body">
            <form action="{{ route('admin.getCusPaymentChq') }}" method="post" id="getCusPayment" class="agetCusPayment" autocomplete="off">
              @csrf
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                         <form action="{{ route('admin.updateCustomerPaymentChq'); }}" method="post" id="update-cus-payment-form">
                            @csrf
