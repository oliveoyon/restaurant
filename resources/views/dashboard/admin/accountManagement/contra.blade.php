...
@section('title', 'Contra Transactions')
@push('admincss')
      ...
      <div class="container-fluid">
        ...
        <div class="card card-success " id="cards">
          <div class="card-header">
            <h3 class="card-title">Contra Transactions</h3>

          </div>
          <!-- /.card-header -->
          <div class="card-body">
            <form action="{{ route('admin.contraaction') }}" method="post" id="add-ob-form" class="add-ob-form" autocomplete="off">
              @csrf
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group row">
                      <label for="colFormLabelSm" class="col-sm-3 col-form-label col-form-label-sm">Debit Account</label>
                      <div class="col-sm-9">
                        <select name="debit_account" class="form-control  form-control-sm select2bs4" >
                            <option value="">--Select a Category--</option>
                            @foreach ($accheads as $acc)
                                <option value="{{ $acc->code }}">{{ $acc->account_name .' - '. $acc->account_head }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group row">
                        <label for="colFormLabelSm" class="col-sm-3 col-form-label col-form-label-sm">Credit Account</label>
                        <div class="col-sm-9">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <input type="text" name="trns_date" class="form-control form-control-sm datepicker" value="" >
