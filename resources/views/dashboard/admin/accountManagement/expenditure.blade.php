        ...
        <div class="content">
            <div class="container-fluid">
                ...
                <div class="card card-success " id="cards">
                    ...
                    <!-- /.card-header -->
                    <div class="card-body">
                        <form action="{{ route('admin.expaction') }}" method="post" id="add-ob-form" class="add-ob-form"
                            autocomplete="off">
                            @csrf
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group row">
                                        <label for="colFormLabelSm"
                                            class="col-sm-3 col-form-label col-form-label-sm">Expenditure Type</label>
                                        <div class="col-sm-9">
                                    ...
                                    <div class="form-group row">
                                        <label for="colFormLabelSm"
                                            class="col-sm-3 col-form-label col-form-label-sm">Expenditure From</label>
                                        <div class="col-sm-9">
