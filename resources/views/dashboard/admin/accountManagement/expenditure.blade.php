    ...
    <div class="content">
      <div class="container-fluid">
        ...
        <div class="card card-success " id="cards">
          ...
          <!-- /.card-header -->
          <div class="card-body">
            <form action="{{ route('admin.expaction') }}" method="post" id="add-ob-form" class="add-ob-form" autocomplete="off">
              @csrf
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group row">
                      <label for="colFormLabelSm" class="col-sm-3 col-form-label col-form-label-sm">Expenditure Type</label>
                      <div class="col-sm-9">
                        <select name="acc_head_id" class="form-control  form-control-sm" >
                    ...
                    <div class="form-group row">
                        <label for="colFormLabelSm" class="col-sm-3 col-form-label col-form-label-sm">Expenditure From</label>
                        <div class="col-sm-9">
                          <select name="from_account" class="form-control  form-control-sm">
                              <option value="">--Select a Category--</option>
                              @foreach ($frmaccounts as $frm)
                                  <option value="{{ $frm->code }}">{{ $frm->account_name }}</option>
                              @endforeach
                          </select>
                          <span class="text-danger error-text from_account_error"></span>
                        </div>
                      </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <input type="text" name="exp_date" class="form-control form-control-sm datepicker" value="" >
                          <span class="text-danger error-text exp_date_error"></span>
                        </div>
                      </div>
                ...
                $.ajax({
                    ...
                    success:function(data){
                            if(data.code == 0){
                                ...
                                // toastr.success(data.msg);
                                // location.href = "{{URL::to('admin/expenditure/')}}";
