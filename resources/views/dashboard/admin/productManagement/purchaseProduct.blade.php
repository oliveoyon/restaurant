    ...
    <div class="content">
      <div class="container-fluid">
        ...
        <div class="card card-success " id="cards">
          ...
          <!-- /.card-header -->
          <div class="card-body">
            <form action="{{ route('admin.purchaseProducts') }}" method="post" id="add-product-form" class="addpdtform" autocomplete="off">
              @csrf
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input type="text" name="invoice_no" class="form-control form-control-sm" readonly value="{{ $inv }}" id="colFormLabelSm">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <select class="form-control form-control-sm select2bs4" required  name="supplier_id" style="width: 100%;" id="supplier_selected">
                    ...
                    <div class="form-group row">
                      <label for="colFormLabelSm" class="col-sm-3 col-form-label col-form-label-sm">Shelf</label>
                      <div class="col-sm-9">
                        <select class="form-control form-control-sm" name="shelf_id" style="width: 100%;" >
                ...
                <div class="col-md-6">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-7">
                              <input type="text" name="serial_no" class="form-control form-control-sm" id="colFormLabelSm">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                      <div class="form-group row">
                          ...
                          <div class="col-sm-7">
                            <input type="text" name="batch_no" class="form-control form-control-sm" id="colFormLabelSm">
                          </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-7">
                              <input type="text" name="size" class="form-control form-control-sm" id="colFormLabelSm">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                      <div class="form-group row">
                          ...
                          <div class="col-sm-7">
                            <input type="text" name="color" class="form-control form-control-sm" id="colFormLabelSm">
                          </div>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-7">
                              <input type="text" name="sell_price" class="form-control form-control-sm" required id="colFormLabelSm">
                  ...
                  <div class="row">
                    <div class="col-md-6">
                        <div class="form-group row">
                            <label for="colFormLabelSm" class="col-sm-6 col-form-label col-form-label-sm">Taxes/VAT</label>
                            <div class="col-sm-6">
                              <select name="taxes" class="form-control form-control-sm" id="taxes">
                                  <option data-id="0" value="0">Default @ 0%</option>
                                @foreach ($taxes as $tax)
                                  <option data-id="{{ $tax->tax_value_percent }}" value="{{ $tax->id }}">{{ $tax->tax_short_name.' @ '.$tax->tax_value_percent.'%' }}</option>
                                @endforeach
                              </select>
                              <span class="text-danger error-text taxes_error"></span>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group row">
                          <label for="colFormLabelSm" class="col-sm-5 col-form-label col-form-label-sm">Total Tax</label>
                          <div class="col-sm-7">
                            <input type="text" name="total_tax" class="form-control form-control-sm" readonly id="total_tax">
                            <input type="hidden" name="tax_value_percent" readonly id="tax_value_percent" value="0">
                          </div>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group row">
                          <label for="colFormLabelSm" class="col-sm-6 col-form-label col-form-label-sm">Sub Total Before Tax</label>
                          <div class="col-sm-6">
                            <input type="text" name="sub_total" class="form-control form-control-sm" readonly id="sub_total" value="">
        ...
        <div class="card " id="cards">
          <div class="card-body">
            <form action="{{ route('admin.purchaseProducts1') }}" method="post" id="purchase-product-form" class="addpdtform1" autocomplete="off">
              @csrf
