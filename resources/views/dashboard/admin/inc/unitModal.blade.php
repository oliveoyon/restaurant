<div class="modal fade editUnit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-keyboard="false" data-backdrop="static">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">{{ __('language.edit_unit') }}</h5>
            ...
            <div class="modal-body">
                 <form action="{{ route('admin.updateUnitDetails'); }}" method="post" id="update-unit-form">
                    @csrf
                     <input type="hidden" name="uid">
                     <div class="form-group">
                      <label for="">{{ __('language.unit_name') }}</label>
