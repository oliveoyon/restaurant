...
.childTableRow th, .childTableRow td {
...
<table class="table">
    ...
    @php $milestoneWeight =
       $detail =  \App\Http\Controllers\Admin\SalesReportController::getSaleDetail($inv->invoice_no)
    @endphp
    <tr>
        ...
        <td colspan="7">
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    @php
                        $date = new DateTimeImmutable($det->created_at);
                        $pdate = $date->format('F j, Y');
                        $sum += $det->rate * $det->quantity;
                    @endphp
                    <tr>
                        ...
                        <td style="text-align: right">{{ $det->rate }}</td>
                        <td style="text-align: right">{{ $det->rate * $det->quantity }}</td>
                    </tr>   
                    @empty
