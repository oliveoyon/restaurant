...
<body>
    ...
    <table width="100%" style="font-family: sans-serif; font-size: 14px;" >
        <tr>
            <td width="33%" style="text-align: center">Receiver's Sign:</td>
            <td width="33%" style="text-align: center">Driver's Sign:</td>
            <td width="33%" style="text-align: center">Manager's Sign:</td>              
        </tr>
    </table>
