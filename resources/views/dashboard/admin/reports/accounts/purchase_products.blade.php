...
<html>
    ...
    <body>
        <div class="head">
            ...
            <p style="font-size:18px; font-weight: bold; mts-5;">Purchased Product List</p>
        ...
        <table class="items" width="100%" style="font-size: 14px; border-collapse: collapse;" cellpadding="8">
            ...
            <tbody>
                ...
                @php
                    ...
                    $sum += $pdt->buy_price_with_tax * $pdt->quantity;
                @endphp
                <tr>
                    ...
                    <td>{{ $pdt->batch_no }}</td>
                    <td>{{ $pdt->quantity }}</td>
                    <td style="text-align: right">{{ $pdt->buy_price }}</td>
                    <td>{{ $pdt->tax_value_percent }}</td>
                    <td style="text-align: right">{{ $pdt->sell_price }}</td>
                    <td style="text-align: right">{{ $pdt->buy_price_with_tax * $pdt->quantity }}</td>
