    ...
    <div class="content">
      <div class="container-fluid">
        ...
        <div class="card " id="cards">
          ...
          <!-- /.card-header -->
          <div class="card-body">
            <form action="{{ route('admin.salesAction') }}" method="post" id="add-purchasereturn-form" class="addpdtform" autocomplete="off">
              @csrf
        ...
        <div class="card " id="payments">
          <div class="card-body">
            <form action="{{ route('admin.finalSale') }}" method="post" id="purchase-product-form" class="addpdtform1" autocomplete="off">
              @csrf
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datepicker/1.9.0/js/bootstrap-datepicker.min.js"></script>
  @include('dashboard.admin.adminjs.salesjs')
  <script>
