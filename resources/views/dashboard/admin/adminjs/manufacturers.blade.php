<script>
    ...
    $(function() {
        ...
        $(document).on('click', '#editManufacturerBtn', function() {
            ...
            $.post("{{ route('admin.getManufacturerDetails') }}", {
                manufacturer_id: manufacturer_id
            }, function(data) {
                $('.editManufacturer').find('input[name="uid"]').val(data.details.id);
                $('.editManufacturer').find('input[name="manufacturer_name"]').val(data.details
                    .manufacturer_name);
                $('.editManufacturer').find('select[name="manufacturer_status"]').val(data
                    .details.manufacturer_status);
            ...
            Swal.fire({
                ...
                preConfirm: function() {
                    ...
                    return $.post(url, {
                        ...
                        if (data.code == 1) {
                            $('#manufacturer-table').DataTable().ajax.reload(null,
                                false);
                            toastr.success(data.msg);
                        } else {
